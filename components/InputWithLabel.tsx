	...
	return (
		<div>
			<div className="relative md:mr-16 mt-10">
				<input id={id} {...props} type={type} className="peer placeholder-transparent text-gray-600 border-0 border-b-[1px] dark:text-gray-400 focus:outline-none dark:border-gray-700 dark:bg-gray-800 bg-white font-normal w-64 h-10 flex items-center text-base border-gray-300 rounded" placeholder='adfa' />
