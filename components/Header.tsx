                        ...
                        <div className="px-6 pt-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-bold md:text2xl text-base pl-3 text-gray-800">Da Vinci Panel</p>
                                </div>
            ...
            <div>
                ...
                <nav className="w-full bg-gray-800 shadow">
                    <div className="container px-6 h-16 flex justify-between items-center xl:items-stretch mx-auto">
                        <div className="flex items-center">
                            <h3 className="text-base text-white font-bold tracking-normal leading-tight ml-3 hidden xl:block">Da Vinci Panel</h3>
                        </div>
