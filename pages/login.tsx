        ...
        <div>
            <section className="bg-white dark:bg-gray-900 {-- h-screen --}">
                <div className="mx-auto flex justify-center md:items-center relative md:h-full">
                    <form id="login" className="w-full sm:w-4/6 md:w-3/6 lg:w-4/12 xl:w-3/12 text-gray-800 mb-32 sm:mb-0 my-40 sm:my-12 px-2 sm:px-0" onSubmit={handleSubmit}>
                        <div className="px-2 flex flex-col items-center justify-center mt-8 sm:mt-0">
                            <h2 className="text-4xl dark:text-gray-100 leading-tight pt-8">Da Vinci Panel</h2>
                        </div>
                        <div className="mt-12 w-full px-2 sm:px-6">
                            <div className="flex flex-col mt-5">
                                <label htmlFor="username" className="text-lg font-semibold dark:text-gray-100 leading-tight">
                                    Username
                                </label>
                                <input required name="username" id="username" className="h-10 px-2 w-full rounded mt-2 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 dark:border-gray-700 dark:focus:border-indigo-600 focus:outline-none focus:border focus:border-indigo-700 border-gray-300 border shadow" type="text" />
                            </div>
                            <div className="flex flex-col mt-5">
