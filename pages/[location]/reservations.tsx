...
import { PhoneIcon, PlusIcon, CheckIcon } from "@heroicons/react/solid";
...
export const getStaticPaths: GetStaticPaths = () => {
  const paths = [
    { params: { location: "1/reservations" } },
    { params: { location: "2/reservations" } },
  ];
...
export const getStaticProps: GetStaticProps = async () => {
  return dehydratedState([Paths.Reservations]);
};
        ...
        <div className="bg-white shadow w-full px-6 py-5 mt-4 h-full">
          ...
          <div className="h-full w-full">
            <div className="flex justify-end gap-x-4">
              <button
                onClick={() => router.push(`/${selectedLocationId}`)}
